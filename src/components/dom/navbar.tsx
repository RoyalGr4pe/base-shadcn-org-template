    ...
    const navigationItems = [
        {
            title: "Home",
            href: "/",
            description: "Overview of our financial management platform",
        },
        {
            title: "Platform",
    ...
    return (
        <header className="w-full z-40 fixed top-0 left-0 bg-background">
            <div className="container relative mx-auto min-h-20 flex gap-4 flex-row lg:grid lg:grid-cols-3 items-center px-10 2xl:px-0">
                                            ...
                                            <NavigationMenuContent className="!w-[450px] p-4">
                                                <div className="flex flex-col lg:grid grid-cols-2 gap-4">
                                                    <div className="flex flex-col h-full justify-between">
                                                        ...
                                                        <Button size="sm" className="mt-10" onClick={() => router.push("/sign-up")}>
                                                            Get started
                                                        </Button>
                                                    </div>
                ...
                <div className="flex w-full md:w-auto lg:justify-center">
                    <p className="font-semibold">Salkaro Finance</p>
                </div>
                <div className="flex justify-end w-full gap-4">
                    <Button variant="ghost" className="hidden md:inline" onClick={() => router.push("/docs")}>
                        Documentation
                    </Button>
                    <div className="border-r hidden md:inline"></div>
                    <Button className="hidden md:inline" variant="outline" onClick={() => router.push("/login")}>Sign in</Button>
                    <Button className="hidden md:inline" onClick={() => router.push("/sign-up")}>Get started</Button>
                </div>
